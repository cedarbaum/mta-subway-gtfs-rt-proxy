...
const PREVIOUS_STOPTIMEUPDATES_SQL_PATH = require.resolve('./sql.d/previous-stoptimeupdates.sql')
const SQL_D_PATH = dirname(PREVIOUS_STOPTIMEUPDATES_SQL_PATH)
...
const fetchAndImportScheduleFeed = async (cfg) => {
	...
	const verboseLogging = _importerLogger.isLevelEnabled('debug')
